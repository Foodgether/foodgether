  ...
  return (
    <Container css={{ px: '$24' }}>
      ...
      >
        <Form>
          <div>
            <label htmlFor='name' className='text-xl font-bold text-pink-900 my-10'>
              Name
            </label>
            <Field
              type='text'
          ...
          <div className='mt-2'>
            <label htmlFor='phoneNumber' className='text-xl font-bold text-pink-900 my-10'>
              Phone number
            </label>
            <Field
              type='text'
          ...
          <div>
            <label htmlFor='pin' className='text-xl font-bold text-pink-900 my-10'>
              PIN
            </label>
            <Field
              type='password'
